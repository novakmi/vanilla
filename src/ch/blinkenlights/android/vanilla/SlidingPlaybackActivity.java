	           ...
	           PlaylistDialog.Callback
{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(0, MENU_CLEAR_QUEUE_BEFORE, 20, R.string.dequeue_before);
	...
	public void onSlideFullyExpanded(boolean expanded) {
		...
		final int[] slide_visible = {MENU_HIDE_QUEUE, MENU_CLEAR_QUEUE_BEFORE, MENU_CLEAR_QUEUE, MENU_EMPTY_QUEUE, MENU_SAVE_QUEUE};
